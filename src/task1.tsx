...
import './style.css';
import data1 from './data/task1_1.json';
import data2 from './data/task1_2.json';
  ...
  return (
    <div style={{ margin: 0, padding: 0, position: "absolute", top: 10, width: "97%"}}>
      ...
      <div style={{ marginBottom: "1rem", textAlign: "left", padding: "0.5rem" }}>
        ...
        <button onClick={() => setSelectedWidget(1)}>Task_1</button>
        <button onClick={() => setSelectedWidget(2)}>new_classes</button>
      </div>
